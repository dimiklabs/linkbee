...
type Subscription struct {
	...
	PaddleSubID      string     `gorm:"type:varchar(100)" json:"paddle_sub_id,omitempty"`
	PaddleCustomerID string     `gorm:"type:varchar(100)" json:"paddle_customer_id,omitempty"`
	PaddlePriceID    string     `gorm:"type:varchar(100)" json:"paddle_price_id,omitempty"`
