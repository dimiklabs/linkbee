...
func LoadDBConfig(_ context.Context) *DBConfig {
	...
	viper.SetDefault("DB_USER_WRITE", "shortlink")
	viper.SetDefault("DB_PASSWORD_WRITE", "shortlink")
	...
	viper.SetDefault("DB_USER_READ", "shortlink")
	viper.SetDefault("DB_PASSWORD_READ", "shortlink")
